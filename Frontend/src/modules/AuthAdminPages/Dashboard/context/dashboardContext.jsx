...
export const DashboardProvider = ({ children }) => {
  ...
  const [allDoctors, setAllDoctors] = useState(mockAllDoctors);
  ...
  const stats = useMemo(
    () => ({
      ...
      totalDoctors: allDoctors.filter((d) => d.status === "verified").length,
      totalUsers: users.length,
      totalRejected: allDoctors.filter((d) => d.status === "rejected").length,
