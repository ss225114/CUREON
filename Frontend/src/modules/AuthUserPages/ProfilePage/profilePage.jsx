      ...
      >
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Manage your personal information, medical records, and appointments
          </p>
        </div>
...
// function EmptyProfileState({ onCompleteClick }) {
//   return (
//     <div className="text-center py-12">
//       <div className="inline-flex p-4 bg-blue-100 dark:bg-blue-900/50 rounded-full mb-4">
//         <FaUser className="h-12 w-12 text-blue-600 dark:text-blue-400" />
//       </div>
//       <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">
//         Welcome! Let's set up your profile
//       </h2>
//       <p className="text-gray-600 dark:text-gray-400 mb-6 max-w-md mx-auto">
//         To provide you with the best healthcare experience, we need some
...
//             </h1>
//             <p className="text-gray-600 dark:text-gray-400">
//               Welcome! Let's get started with your health profile
//             </p>
//           </div>
...
//           {/* Profile Header */}
//           <ProfileHeader
//             onEditClick={() => setShowCompleteForm(true)}
