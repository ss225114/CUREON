...
// import { FaSave, FaTimes, FaPlus, FaMinus, FaUpload } from "react-icons/fa";
...
//           relationship: "",
//         },
//         medicalConditions: profile.medicalHistory?.conditions || [""],
...
//     if (step !== totalSteps) {
//       console.warn("Trying to submit before final step");
//       return;
//     }
...
//       console.log("📤 Sending profile data:", filteredData);

//       // Use completeProfile instead of updateProfile if that's what your context provides
//       const result = await completeProfile(filteredData);
...
//       console.log("📤 Final submit data:", filteredData);
...
//                 </span>
//                 <span className="text-sm text-[#293379] dark:text-blue-400">
//                   {Math.round((step / totalSteps) * 100)}% Complete
//                 </span>
//               </div>
//               <div className="h-2 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
//                 <div
//                   className="h-full bg-gradient-to-r from-[#293379] to-[#016b61] rounded-full transition-all duration-300"
