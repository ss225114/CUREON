...
export default function CompleteProfileForm({ onClose, isOpen }) {
  ...
  const addArrayItem = (field) => {
    setFormData(prev => ({
      ...prev,
      [field]: [...prev[field], field === 'medications' ? { name: '', dosage: '', frequency: '' } : '']
    }));
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const filteredData = {
        ...formData,
        medicalConditions: formData.medicalConditions.filter(c => c.trim()),
                  ...
                  >
                    ...
                    <div className="bg-amber-50 dark:bg-amber-900/20 p-4 rounded-lg border border-amber-200 dark:border-amber-700">
                      <p className="text-amber-800 dark:text-amber-300 text-sm">
                        <strong>Note:</strong> This information helps healthcare providers give you better care. 
